...
export const BD: Record<string, BancoRegra> = {
  ...
  // ── BRB (= BRB INCONTA — mesmo banco, digitado via InConta Digital) ──
  // Regras oficiais 07/05/2026: prazo 108m; taxa 1,85% (saldo mín R$3k) e
  // 1,79% (tabela baixa); port até 72 anos, a partir de 12 pagas; limite por
  // CPF R$150k; aceita qualquer taxa origem; troco mín 1 parcela (motor).
  // Benefícios 32/92 só ≥60 anos. NÃO porta: PicPay(380), Bradescard(063),
  // Inbursa(012), PagBank(290), C6(336/626), Agibank(121) + auto-port BRB
  // (070/925). ⚠ Santinvest: código a confirmar.
  BRB: {
